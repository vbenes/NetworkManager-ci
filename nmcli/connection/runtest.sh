...
#if [ $1 == "testcase_300566" ]; then #[ $1 == "testcase_300565" ] ||
#    sudo -u test behave nmcli/connection/features -t $1 -k -f html -o /tmp/report_$TEST.html -f plain; rc=$?
#else
behave nmcli/connection/features -t $1 -k -f html -o /tmp/report_$TEST.html -f plain; rc=$?
#fi
